...
@section('content')
    ...
    @include('frontend.common.breadcrumb.index')
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Email</h4>
                        <p><a href="https://preview.colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3159545d5d5e71525e5d5e435d58531f525e5c">[email&#160;protected]</a></p>
                    </div>
                </div>
            </div>
        </div>
